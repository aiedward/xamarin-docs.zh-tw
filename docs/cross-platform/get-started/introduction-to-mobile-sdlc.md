...
此外，板型規格也會影響 UX 決策。 平板電腦具有更大的空間，因此可以顯示更多資訊。 通常在手機上需要以多張畫面顯示的內容，在平板電腦可壓縮到一張畫面中：
 ...
 [![](introduction-to-mobile-sdlc-images/iphone-vs-ipad.png "通常在手機上須以多個畫面才能顯示的內容，在平板電腦可壓縮到一個畫面")](introduction-to-mobile-sdlc-images/iphone-vs-ipad.png#lightbox)
