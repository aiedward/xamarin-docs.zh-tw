...
## <a name="using-async-amp-await"></a>Using async &amp; await
...
### <a name="writing-an-async-method"></a>Writing an async method
...
### <a name="calling-an-async-method-1"></a>Calling an async method 1
...
### <a name="calling-an-async-method-2"></a>Calling an async method 2
