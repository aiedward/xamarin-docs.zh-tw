...
3. 從安裝畫面選取 [使用 .NET 進行行動開發]  工作負載：
    ...
    [![使用 .NET 選項進行行動開發](~/get-started/installation/windows-images/vs2019-mobile-dev-workload-sml.png)](~/get-started/installation/windows-images/vs2019-mobile-dev-workload.png#lightbox)
...
如已安裝 Visual Studio 2019，您可以重新執行 Visual Studio 2019 安裝程來式修改工作負載以新增 Xamarin (如需詳細訊，請參閱[修改 Visual Studio](/visualstudio/install/modify-visual-studio))。 接著，請依照上面所列的步驟來安裝 Xamarin。

如需下載和安裝 Visual Studio 2019 的詳細資訊，請參閱[安裝 Visual Studio 2019](/visualstudio/install/install-visual-studio)。