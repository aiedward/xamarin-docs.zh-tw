...
如需有關統一的 API 的詳細資訊，請參閱[統一的 API](~/cross-platform/macios/unified/index.md)文件。 如需有關支援的 32 和 64 位元應用程式架構的相關資訊的詳細背景，請參閱[32 和 64 位元平台考量](~/cross-platform/macios/32-and-64/index.md)文件。
