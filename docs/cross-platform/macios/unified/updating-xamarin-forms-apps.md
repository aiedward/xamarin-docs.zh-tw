...
遷移的一部分需要將 Xamarin. form 升級至版本 1.3, 以支援 Unified API。 為了要建立正確的元件參考, 我們必須先更新 iOS 專案, 以使用 Unified API。
...
現在, 您應該將 Xamarin 應用程式更新為版本 1.3.1, 並將 iOS 應用程式遷移至 Unified API (在 iOS 平臺上支援64位架構)。
