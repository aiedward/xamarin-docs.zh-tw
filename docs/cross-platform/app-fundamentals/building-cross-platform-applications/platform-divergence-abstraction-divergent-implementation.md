...
請參閱[Xamarin.Forms](~/get-started/index.yml)文件。

### <a name="other-cross-platform-libraries"></a>其他跨平台程式庫

這些程式庫也會提供跨平台功能，如C#開發人員：

- [**Xamarin.Essentials** ](~/essentials/index.md) – 一般功能的跨平台 Api。
- [**SkiaSharp** ](~/xamarin-forms/user-interface/graphics/skiasharp/index.md) -跨平台 2D 圖形。
...
使用 `WINDOWS_UWP`。 沒有底線周圍的字串，例如 Xamarin 平台符號。
