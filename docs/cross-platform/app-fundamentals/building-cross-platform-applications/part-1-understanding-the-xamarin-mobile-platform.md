...
這些螢幕擷取畫面顯示每個平台可用的視覺化畫面設計工具：
 ...
 [ ![](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png "這些螢幕擷取畫面顯示每個平台上可用的視覺化畫面設計工具")](part-1-understanding-the-xamarin-mobile-platform-images/designer-all1.png)
