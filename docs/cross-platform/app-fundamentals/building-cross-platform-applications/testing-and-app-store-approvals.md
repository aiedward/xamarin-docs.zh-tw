...
description: 本文件說明如何測試跨平台應用程式裝置、 管理測試案例自動化測試、 執行單元測試和應用程式送出程序完成。
ms.prod: xamarin
...
- Windows 開發人員應該造訪[Windows 開發人員中心](https://developer.microsoft.com/windows/windows-apps)若要閱讀有關送出自己的應用程式。
