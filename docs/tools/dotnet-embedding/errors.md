...
### <a name="em1010-type-t-is-not-generated-because-x-are-not-supported"></a>EM1010:型別`T`就不會產生，因為`X`不支援。
...
### <a name="em1011-type-t-is-not-generated-because-it-lacks-marshaling-code-with-a-native-counterpart"></a>EM1011:型別`T`則不會產生，因為它缺少封送處理程式碼與原生對應。
...
### <a name="em1041-indexed-properties-on-t-is-not-generated-because-multiple-indexed-properties-are-not-supported"></a>EM1041:索引屬性上`T`就不會產生，因為不支援多個索引的屬性。
