...
Android、iOS 與 UWP 提供獨一無二的作業系統與平台 API，開發人員可以在 C# 中使用 Xamarin 存取全部項目。 Xamarin.Essentials提供單一跨平臺 API，可與任何 Xamarin.Forms 、Android、iOS 或 UWP 應用程式搭配使用，無論使用者介面建立的方式為何，都能從共用的程式碼存取。

## <a name="get-started-with-xamarinessentialsget-startedmdcontextxamarinxamarin-forms"></a>[開始使用Xamarin.Essentials](get-started.md?context=xamarin/xamarin-forms)

遵循使用者入門[指南](get-started.md)，將 **Xamarin.Essentials** NuGet 套件安裝到現有或新 Xamarin.Forms 的、ANDROID、iOS 或 UWP 專案。

## <a name="feature-guides"></a>功能指南

遵循指南，將這些 Xamarin.Essentials 功能整合到您的應用程式中：
