...
1. 啟動 Visual Studio，然後建立名為 **ButtonTutorial** 的全新空白 Xamarin.Forms 應用程式。
...
1. 啟動 Visual Studio for Mac，然後建立名為 **ButtonTutorial** 的全新空白 Xamarin.Forms 應用程式。
