...
如需有關這些必要條件的詳細資訊，請參閱 <<c0> [ 安裝 Xamarin](~/get-started/installation/index.md)。 連接到 Mac 組建主機的 Visual Studio 2019 的相關資訊，請參閱[進行 Xamarin.iOS 開發的 Mac 配對](~/ios/get-started/installation/windows/connecting-to-mac/index.md)。
