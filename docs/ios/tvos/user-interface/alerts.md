---
title: 使用 Xamarin 中 tvOS 警示
description: 本文件說明如何使用 Xamarin tvOS 警示。 其中也會討論顯示警示文字，將欄位和加入協助程式類別。
ms.prod: xamarin
...
ms.locfileid: "34789079"
---
# <a name="working-with-tvos-alerts-in-xamarin"></a>使用 Xamarin 中 tvOS 警示
