...
|媒體櫃/喜好設定/|應用程式特定的喜好設定檔案會儲存在這個目錄中。 請勿直接建立這些檔案。 請`NSUserDefaults`改用類別。<br /><br />ITunes 會備份此目錄的內容。|
...
[![](file-system-images/08-library-directory.png "這個螢幕擷取畫面顯示搜尋工具視窗中的目錄結構")](file-system-images/08-library-directory.png#lightbox)
