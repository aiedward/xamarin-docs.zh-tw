...
本指南說明了「功能」(或稱「應用程式服務」)__，也描述了如何在 Visual Studio 和 Apple Developer Center (Apple 開發人員中心) 中啟用這些功能。 此外，也詳細說明了如何設定更複雜的服務，例如「電子錢包」、iCloud、Apple Pay 及「應用程式群組」。 最後，還涵蓋了取得設定和簡單疑難排解選項的後續步驟。
