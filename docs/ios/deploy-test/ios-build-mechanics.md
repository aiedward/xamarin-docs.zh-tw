...
2. 在左側樹狀檢視中，選取 [專案] > [建置]
3. 在右側面板中，將記錄詳細資訊下拉式清單設定為 [診斷]：[![](ios-build-mechanics-images/image2.png "設定記錄詳細資訊")](ios-build-mechanics-images/image2.png)
4. 按一下 [確定] 
...
3. 在右側面板中，將 [MSBuild 建置輸出詳細資訊] 下拉式清單設定為 [診斷]：[ ![](ios-build-mechanics-images/image2-vs.png "設定 MSBuild 建置輸出詳細資訊")](ios-build-mechanics-images/image2-vs.png)
4. 按一下 [確定] 
5. 清除並重建您的套件。
6. 診斷輸出會顯示在 [輸出] 面板中。
...
[ ![](ios-build-mechanics-images/image3.png "設定選項")](ios-build-mechanics-images/image3.png)
...
[ ![](ios-build-mechanics-images/image4.png "設定選項")](ios-build-mechanics-images/image4.png)
