...
10. 在 **[一般 > 身分識別** ] 下，確定套件組合 **識別碼**_完全符合_ 您在 plist 中找到的 Xamarin iOS 應用程式套件組合識別碼。
...
- [應用程式服務的布建](~/ios/get-started/installation/device-provisioning/index.md#provisioning-for-application-services)
