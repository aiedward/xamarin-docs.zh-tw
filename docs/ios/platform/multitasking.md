...
[ ![](multitasking-images/about01.png "投影片上面板")](multitasking-images/about01.png)
...
[ ![](multitasking-images/about02.png "分割檢視")](multitasking-images/about02.png)
...
[ ![](multitasking-images/about03.png "範例圖片浮動視窗中的圖片")](multitasking-images/about03.png)
...
IOS 9 之前，您可以設計您的應用程式 agains 特定裝置的螢幕大小和方向。 因為滑出面板中，或在分割檢視模式中，現在可以執行應用程式，它可以尋找執行中壓縮或規則的水平大小類別 ipad，無論裝置的實體的方向或螢幕大小本身。

[ ![](multitasking-images/sizeclasses01.png "螢幕大小和方向的考量")](multitasking-images/sizeclasses01.png)
...
<table width=100% border="1px">
    ...
    <tr>
        <td><b>Portrait</b></td>
        <td>75%的螢幕<br/>Compact 水平<br/>規則的垂直</td>
        <td>25%的螢幕<br/>Compact 水平<br/>規則的垂直</td>
    </tr>
    <tr>
        <td><b>橫向</b></td>
        <td>75%的螢幕<br/>規則的水平<br/>規則的垂直</td>
        <td>25%的螢幕<br/>Compact 水平<br/>規則的垂直</td>
    </tr>
    <tr>
        <td><b>橫向</b></td>
        <td>50%的螢幕<br/>Compact 水平<br/>規則的垂直</td>
        <td>50%的螢幕<br/>Compact 水平<br/>規則的垂直</td>
    </tr>
</table>
...
[ ![](multitasking-images/sizeclasses03.png "清單和詳細資料檢視，顯示在相同的時間")](multitasking-images/sizeclasses03.png)

如果投影片上面板中執行相同的應用程式時，它會配置為 Compact 的水平大小類別，並顯示只有清單：

[ ![](multitasking-images/sizeclasses04.png "僅限時裝置是水平顯示清單")](multitasking-images/sizeclasses04.png)
...
[ ![](multitasking-images/keyboard01.png "應用程式切換器")](multitasking-images/keyboard01.png)

使用者如果 iOS 9 應用程式包含鍵盤快速鍵，可以按住**命令**，**選項**或**控制項**它們顯示在快顯視窗中的索引鍵：

[ ![](multitasking-images/keyboard02.png "鍵盤快速鍵快顯視窗")](multitasking-images/keyboard02.png)
...
[ ![](multitasking-images/keyboard03.png "鍵盤快速鍵快顯視窗")](multitasking-images/keyboard03.png)
...
[ ![](multitasking-images/fullscreen01.png "選擇向外多工作業")](multitasking-images/fullscreen01.png)
...
- [MultiTask （範例）](http://developer.xamarin.comhttps://developer.xamarin.com/samples/monotouch/ios9/MultiTask/)
