...
[![](healthkit-images/image01.png "範例應用程式記錄的使用者核心比率")](healthkit-images/image01.png)
...
> [!IMPORTANT]
> **注意：** iOS 8 中引進健全狀況的套件。 目前健全狀況套件並不適用於在 iOS 模擬器中，而偵錯需要連線至實體 iOS 裝置。
...
[![](healthkit-images/image02.png "註冊 Apple 開發人員入口網站上的應用程式")](healthkit-images/image02.png)
...
[![](healthkit-images/image03.png "選取明確的應用程式識別碼")](healthkit-images/image03.png)

按一下**繼續**與工作其餘的畫面，您將在其中指定您**開發人員憑證**，**裝置**，和**名稱**這個**佈建設定檔**:

[![](healthkit-images/image04.png "產生佈建設定檔")](healthkit-images/image04.png)
...
[![](healthkit-images/image05.png "在 Xcode 中檢視設定檔")](healthkit-images/image05.png)
...
[![](healthkit-images/image06.png "輸入明確的應用程式識別碼")](healthkit-images/image06.png)

現在請切換到**iOS 套件組合簽署**面板。 您最近若曾安裝**佈建設定檔**，與它關聯到明確**應用程式識別碼**，現在可以為**佈建設定檔**:

[![](healthkit-images/image07.png "選取 佈建設定檔")](healthkit-images/image07.png)
...
[![](healthkit-images/image08.png "HKSampleType 物件圖表")](healthkit-images/image08.png)
...
[![](healthkit-images/image09.png "大部分的健全狀況套件中的資料類型 HKQuantityType，並將其資料儲存在 HKQuantitySample 物件")](healthkit-images/image09.png)
...
[![](healthkit-images/image10.png "使用者會看到一個系統控制健全狀況存取對話方塊")](healthkit-images/image10.png)

更新版本中，使用者可以變更使用應用程式健全狀況的權限**來源**對話方塊：

[![](healthkit-images/image11.png "使用者可以變更權限使用健全狀況的應用程式來源對話方塊")](healthkit-images/image11.png)
...
> [!IMPORTANT]
> **注意：**要清楚了解這個函式的引數：_成功_和_錯誤_參數不會指出使用者是否已授與權限可以存取健康情況套件資料 ！ 它們只是表示，使用者具有以允許存取資料的機會。
...
> [!IMPORTANT]
> **注意：**佈建與相關的錯誤會在此時介面。 若要解決錯誤，檢閱建立和佈建的應用程式健全狀況套件上面。 元件如下： 
>
...
[![](healthkit-images/image12.png "使用者會看到這個對話方塊")](healthkit-images/image12.png)
...
[![](healthkit-images/image13.png "這個圖表可顯示事件的順序")](healthkit-images/image13.png)
