...
請附加 XS 記錄**~/Library/Logs/XamarinStudio-{VERSION}/Ide-{TIMESTAMP}.log**， **AndroidTools-{TIMESTAMP}.log**，和 * * 元件-{TIMESTAMP}.log * * (在舊版 XS /MonoDevelop，只需傳送**~/Library/Logs/MonoDevelop-(3.0|2.8|2.6)/MonoDevelop.log**)。
