...
-   **設計工具工具列**&ndash;會顯示一份選取器︰**裝置**，**版本**，**佈景主題**，版面配置設定及動作列設定。 **設計工具工具列**也包含圖示以啟動 佈景主題編輯器及啟用材質設計格線。
...
-   **工具列**&ndash;會顯示一份選取器︰**裝置**，**版本**，**佈景主題**，版面配置設定及動作列設定。 工具列也包含圖示以啟動 佈景主題編輯器及啟用材質設計格線。
