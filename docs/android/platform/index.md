...
ms.locfileid: "86996886"
---
# <a name="xamarinandroid-platform-features"></a>Xamarin. Android 平臺功能
...
本文概述 Android 圓形圖的新功能，說明如何準備 Xamarin 以進行 Android 開發，並提供範例應用程式，說明如何在 Xamarin Android 應用程式中使用新的 Android 圓形圖顯示切除和通知功能。
...
本文介紹 AndroidManifest.xml 檔案，以及如何使用它來控制功能及描述 Mono for Android 應用程式的需求。
...
## <a name="maps-and-location"></a>[地圖和位置](~/android/platform/maps-and-location/index.md)
...
本指南說明如何建立 c # 系結以 Kotlin 程式碼，讓您可以在 Xamarin Android 應用程式中使用原生程式庫。
