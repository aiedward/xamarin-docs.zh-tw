...
##### [Xamarin 裝置管理員](get-started/installation/android-emulator/xamarin-device-manager.md)
##### [Google 模擬器管理員](get-started/installation/android-emulator/google-emulator-manager.md)
...
### [在 Java 中內嵌 .NET](platform/embedding-net-in-java.md)
...
#### [使用片段實作](platform/fragments/implementing-with-fragments/index.md)
##### [逐步解說](platform/fragments/implementing-with-fragments/walkthrough.md)
##### [支援預先 Honeycomb](platform/fragments/implementing-with-fragments/supporting-pre-honeycomb.md)
...
#### [Android SDK 模擬器](deploy-test/debugging/android-sdk-emulator/index.md) \(英文\)
##### [正在執行模擬器](deploy-test/debugging/android-sdk-emulator/running-the-emulator.md)
##### [疑難排解](deploy-test/debugging/android-sdk-emulator/troubleshooting.md)
#### [Visual Studio Android 模擬器](deploy-test/debugging/visual-studio-android-emulator.md)
