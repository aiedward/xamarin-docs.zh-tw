...
通用 Windows 平台，在下列平台特有的功能被供 Xamarin.Forms 檢視、 頁面和配置而定：
...
在通用 Windows 平台 (UWP)，Xamarin.Forms 檢視被提供下列平台特有的功能：
...
通用 Windows 平台上為 Xamarin.Forms 頁面提供了下列平台特有的功能：
