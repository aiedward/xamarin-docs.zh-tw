...
|     |     |
| --- | --- |
| <h3>核取方塊</h3>允許選取 `boolean` 值。<p align="center">![核取方塊的螢幕擷取畫面](xaml-controls-images/CheckBox.png "核取方塊")</p> [輥](~/xamarin-forms/user-interface/checkbox.md) | <p valign="center"><pre>&lt;CheckBox IsChecked="true"<br />          HorizontalOptions="Center"<br />          VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
| <h3>滑桿</h3>允許從連續範圍選取 `double` 值。<p align="center">![滑杆的螢幕擷取畫面](xaml-controls-images/Slider.png "滑桿")</p>[API](xref:Xamarin.Forms.Slider) /  [指南](~/xamarin-forms/user-interface/slider.md) | <p valign="center"><pre>&lt;Slider Minimum="0"<br />        Maximum="100"<br />        VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
| <h3>Stepper</h3>允許從增量範圍選取 `double` 值。<p align="center">![分檔器的螢幕擷取畫面](xaml-controls-images/Stepper.png "Stepper")</p>[API](xref:Xamarin.Forms.Stepper) /  [指南](~/xamarin-forms/user-interface/stepper.md) | <p valign="center"><pre>&lt;Stepper Minimum="0"<br />         Maximum="10"<br />         Increment="0.1"<br />         HorizontalOptions="Center"<br />         VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
...
| <h3>編輯器</h3>允許輸入和編輯多行文字。<p align="center">![編輯器的螢幕擷取畫面](xaml-controls-images/Editor.png "ThisAddIn")</p>[API](xref:Xamarin.Forms.Editor) /  [指南](~/xamarin-forms/user-interface/text/editor.md) | <p valign="center"><pre>&lt;Editor VerticalOptions="FillAndExpand" /&gt;</pre></p> |
|     |     |
...
| <h3>ProgressBar</h3>顯示動畫，以顯示應用程式正在經歷冗長的活動。<p align="center">![ProgressBar 的螢幕擷取畫面](xaml-controls-images/ProgressBar.png "ProgressBar")</p>[API](xref:Xamarin.Forms.ProgressBar) /  [指南](~/xamarin-forms/user-interface/progressbar.md) | <p valign="center"><pre>&lt;ProgressBar Progress=".5"<br />             VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
|     |     |
...
| <h3>IndicatorView</h3>顯示表示 `CarouselView`中專案數的指標。<p align="center">![IndicatorView 的螢幕擷取畫面](xaml-controls-images/IndicatorView.png "IndicatorView")</p>[輥](~/xamarin-forms/user-interface/indicatorview.md) | <p valign="center"><pre>&lt;IndicatorView ItemsSourceBy="carouselView"<br />               IndicatorColor="LightGray"<br />               SelectedIndicatorColor="DarkGray" /&gt;</pre></p> |
