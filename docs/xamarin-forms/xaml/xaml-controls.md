...
## <a name="views-for-presentation"></a>簡報的視圖
...
## <a name="views-that-initiate-commands"></a>起始命令的視圖
...
## <a name="views-for-editing-text"></a>編輯文字的視圖
...
## <a name="views-to-indicate-activity"></a>用來表示活動的視圖
...
## <a name="views-that-display-collections"></a>顯示集合的視圖
