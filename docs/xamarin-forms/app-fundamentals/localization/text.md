...
[![將資源檔加入](text-images/resx-new-file-sml.png "新檔案對話方塊")](text-images/resx-new-file.png#lightbox "新檔案 對話方塊")
...
[![](text-images/vs-resx-internal-sml.png "AppResources.Resx 屬性 視窗")](text-images/vs-resx-internal.png#lightbox)

# <a name="visual-studio-for-mactabvsmac"></a>[Visual Studio for Mac](#tab/vsmac)

[![](text-images/xs-resx-internal-sml.png "AppResources.Resx 屬性板")](text-images/xs-resx-internal.png#lightbox)
...
[![](text-images/vs-resx-public-sml.png "AppResources.Resx 屬性 視窗")](text-images/vs-resx-public.png#lightbox)
...
[![](text-images/xs-resx-public-sml.png "AppResources.Resx 屬性板")](text-images/xs-resx-public.png#lightbox)
...
![](text-images/appresources-langs.png "將語言特定資源檔")
...
![](text-images/simple-example-english.png "跨平台 Ui 之前轉譯")
...
![當地語系化 Info.plist 中的索引鍵](text-images/info-plist.png "當地語系化 Info.plist 中的索引鍵")
...
![](text-images/ios-imageicon.png "範例應用程式文字和影像當地語系化的 iOS")
...
![](text-images/android-resources.png "Android 當地語系化 Drawables 和字串的目錄")
...
![](text-images/android-imageicon.png "Android 的範例應用程式文字和影像當地語系化")
...
![](text-images/uwp-image-folder-structure.png "UWP 映像當地語系化資料夾結構")
