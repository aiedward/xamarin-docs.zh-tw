...
使用半透明的文字所示**程式碼更多程式碼**頁面[ **SkiaSharpFormsDemos** ](https://developer.xamarin.com/samples/xamarin-forms/SkiaSharpForms/Demos/)範例。 此頁面會淡兩個文字字串和縮小透過合併中的 transparency`SKColor`值：
