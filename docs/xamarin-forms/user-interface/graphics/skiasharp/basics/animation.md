---
title: 在 SkiaSharp 基本動畫
description: 本文章說明如何建立動畫 SkiaSharp 圖形 Xamarin.Forms 應用程式中，並示範此範例程式碼。
ms.prod: xamarin
...
ms.locfileid: "35243339"
---
# <a name="basic-animation-in-skiasharp"></a>在 SkiaSharp 基本動畫
