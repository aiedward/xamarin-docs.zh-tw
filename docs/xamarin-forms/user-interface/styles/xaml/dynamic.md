---
title: Xamarin.Forms 中的動態樣式
description: 本文說明如何 Xamarin.Forms 應用程式可以回應在執行階段動態樣式變更所使用的動態的資源。
ms.prod: xamarin
...
ms.locfileid: "35245217"
---
# <a name="dynamic-styles-in-xamarinforms"></a>Xamarin.Forms 中的動態樣式
