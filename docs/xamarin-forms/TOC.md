...
#### [Azure 通知中樞](data-cloud/push-notifications/azure-notification-hub.md)
#### [Azure 行動裝置應用程式](data-cloud/push-notifications/azure.md)
...
### [使用 Visual Studio App Center 進行自動化測試](/appcenter/test-cloud/uitest/get-started-xamarin-forms)
