---
title: 使用 Xamarin.Forms 中的 Azure Cosmos DB 文件資料庫
...
ms.locfileid: "67659225"
---
# <a name="consume-an-azure-cosmos-db-document-database-in-xamarinforms"></a>使用 Xamarin.Forms 中的 Azure Cosmos DB 文件資料庫
