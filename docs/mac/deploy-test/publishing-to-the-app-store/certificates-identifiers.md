...
> [!div class="mx-imgBorder"]
> [![選取憑證、識別碼及設定檔](certificates-identifiers-images/devcenter02.png)](certificates-identifiers-images/devcenter02-large.png#lightbox)
...
1. 如果資訊正確無誤，請按一下 [註冊]  完成設定：
    ...
    > [!div class="mx-imgBorder"]
    > [![檢閱輸入的資料](certificates-identifiers-images/appid04.png)](certificates-identifiers-images/appid04-large.png#lightbox)
...
1. 輸入要新增電腦的 [Name] \(名稱\)  與 [UUID]  ，然後按一下 [Continue] \(繼續\)  按鈕。 檢閱資訊，然後按一下 [Register] \(註冊\)  按鈕：
    ...
    > [!div class="mx-imgBorder"]
    > [![輸入新電腦的資訊](certificates-identifiers-images/device02.png)](certificates-identifiers-images/device02-large.png#lightbox)

1. 檢閱與確認輸入的資料：

    > [!div class="mx-imgBorder"]
    > [![輸入新電腦的資訊](certificates-identifiers-images/device03.png)](certificates-identifiers-images/device03-large.png#lightbox)
