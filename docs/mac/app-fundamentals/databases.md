...
[![執行中應用程式的範例](databases-images/intro01.png "執行的應用程式的範例")](databases-images/intro01-large.png)
...
2. 同時選取**Mono.Data.Sqlite**和**System.Data**組件： 
    ...
    [![將必要的參考加入](databases-images/reference01.png "加入必要的參考")](databases-images/reference01-large.png)
...
[![公開下拉式方塊插座](databases-images/combo01.png "公開下拉式方塊輸出")](databases-images/combo01-large.png)
...
2. 輸入`SQLite.net`中**搜尋方塊**選取**sqlite net**項目：
    ...
    [![新增 SQLite NuGet 套件](databases-images/nuget01.png "新增 SQLite NuGet 套件")](databases-images/nuget01-large.png)
3. 按一下**加入封裝**按鈕，以完成。
...
[![公開資料表檢視插座](databases-images/table01.png "公開資料表檢視輸出")](databases-images/table01-large.png)
