...
#### <a name="mm0050-you-cannot-provide-a-root-assembly-if---no-root-assembly-is-passed"></a>MM0050:如果，傳遞沒有根組件，您無法提供根組件。
...
#### <a name="mm1604-file-of-type-0-is-not-a-macho-file-1"></a>MM1604:檔案型別的{0}不是 MachO 檔案 ({1})。
...
#### <a name="mm2001-could-not-link-assemblies"></a>MM2001:無法將組件的連結
...
#### <a name="mm2004-extra-linker-definitions-file-0-could-not-be-located"></a>MM2004:額外的連結器定義檔 '{0}' 找不到。

<a name="MM2005" />

#### <a name="mm2005-definitions-from-0-could-not-be-parsed"></a>MM2005:定義從 '{0}' 無法剖析。
...
#### <a name="mm2014-xamarinmac-extensions-do-not-support-linking-request-for-linking-will-be-ignored--this-message-is-obsolete-in-xm-36-"></a>MM2014:Xamarin.Mac 延伸模組不支援連結。 將略過連結要求。 ** 這個訊息是 XML 3.6 + 中的過時 \*\*
...
#### <a name="mm2100-xamarinmac-classic-api-does-not-support-platform-linking"></a>MM2100:Xamarin.Mac 的傳統 API 不支援的平台連結。

<a name="MM2103" />

#### <a name="mm2103-error-processing-assembly--"></a>MM2103:處理組件時發生錯誤 '\*': *
...
#### <a name="mm4134-your-application-is-using-the-0-framework-which-isnt-included-in-the-macos-sdk-youre-using-to-build-your-app-this-framework-was-introduced-in-osx-2-while-youre-building-with-the-macos-1-sdk-this-configuration-is-not-supported-with-the-static-registrar-pass---registrardynamic-as-an-additional-mmp-argument-in-your-projects-mac-build-option-to-select-alternatively-select-a-newer-sdk-in-your-apps-mac-build-options"></a>MM4134:您的應用程式使用 '{0}' framework，不會包含於您用來建置您的應用程式的 MacOS SDK (OSX 中引進了此架構{2}，而您要建置使用 MacOS {1} SDK。)此組態不支援靜態的註冊機構 (pass，註冊機構： 動態為專案的 Mac 組建 選項以選取 其他 mmp 引數)。 或者您的應用程式的 Mac 組建選項中選取較新的 SDK。
...
#### <a name="mm5202-monoframework-mdk-is-missing-please-install-the-mdk-for-your-monoframework-version-from-httpmono-projectcomdownloads"></a>MM5202:找不到 Mono.framework MDK。 請安裝 從您 Mono.framework 版本 MDK http://mono-project.com/Downloads
...
#### <a name="mm5205-invalid-architecture-0-valid-architectures-are-i386-and-x8664-when---profilemobile"></a>MM5205:無效的架構 '{0}'。 有效的架構是 i386 及 x86_64 (當-程式碼剖析 = 行動裝置)。
...
#### <a name="mm5309-native-linking-failed-with-error-code-1--check-build-log-for-details"></a>MM5309:原生連結失敗，錯誤代碼 1。  檢查組建記錄檔以取得詳細資料。
